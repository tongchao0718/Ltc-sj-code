...
| 3 | **`_resources/`** + **全量可交互代码** + `03-PRD`（草案）、`04-界面设计文档.md`、`产品设计文档.md` |
| 4 | `G2-A预审报告.md`、`19-G2-A界面确认记录.md`、`03-PRD`（冻结）、`页面-路由-接口-数据表映射表.md` |
...
| web-* 资源库 | `AIEP-WEB/src/apps/{app-code}/_resources/` |
...
| G2-A 预审 | `04-AI治理与审计/G2-A预审报告.md` |
| 资源库规范 | `核心文档/AI+产品落地/01-AI全流程设计/子应用资源库规范.md` |
