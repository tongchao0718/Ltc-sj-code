<template>
  ...
  <ArcoDemoShell variant="plain" :crumbs="[]">
    <div class="wp-root">
      <div class="wp-left">
        <div class="wp-stack">
                ...
                <div class="wp-stat-txt">
                  ...
                  <div class="wp-stat-valrow">
                    <template v-if="s.key === 'a'">
                      <span class="num">373.5</span><span class="suffix-w">W+</span
                      ><span class="unit">个</span>
                    </template>
                    <template v-else-if="s.key === 'b'">
                      <span class="num">368</span><span class="unit">个</span>
                    </template>
                    <template v-else-if="s.key === 'c'">
                      <span class="num">8,874</span><span class="unit">个</span>
                    </template>
                    <template v-else>
                      <span class="num">2.8</span><span class="pct">%</span>
